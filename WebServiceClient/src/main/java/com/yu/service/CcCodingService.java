...
public interface CcCodingService {
    ...
    @WebMethod
    /*@RequestWrapper(localName = "getAtributeValue", targetNamespace = "http://service.yu.com", className = "com.yu.service.GetAtributeValue")
    @ResponseWrapper(localName = "getAtributeValueResponse", targetNamespace = "http://service.yu.com", className = "com.yu.service.GetAtributeValueResponse")
    @WebResult(name = "return", targetNamespace = "")*/
    public java.lang.String getAtributeValue(
